...
This branch contains also the protocol-version implementation of EdgeSHAPer. In the ```protocol``` folder, it is possible to find the results of the execution of the scripts. This branch is currelty up to date with ```main```.
